  ...
  Widget build(BuildContext context) {
    return BlocConsumer<ProfileSetupCubit, ProfileSetupState>(
      listener: (context, state) {
        ...
        } else if (state is UserUpdatedFailure) {
          Toast.error(context, state.message);
        }
      },
      builder: (context, state) {
        return CustomModalProgressHUD(
          state: state is UserUpdatedLoading,
              ...
              children: [
                                    ...
                                    .updateUserProfile(
                                      updatedUser: UserModelDto(
                                        ...
                                        fullName: fullNameController.text
                                            .trim(),
                                        imageUrl: state is UploadImageSuccess
                                            ? state.url
                                            : null,
                                      ),
                                    );
                ...
                Positioned(
                  ...
                  child: CustomUploadImageWidget(
                    image: state is UploadImageSuccess ? state.url : null,
                    onTap: () {
                      context.read<ProfileSetupCubit>().uploadProfileImage();
                    },
                  ),
                ),
              ],
