...
import 'package:pawty/features/profile/presentation/view/widgets/custom_dropdown_menu_container.dart';
...
class ProfileSetupBody extends StatefulWidget {
  ...
  static List<String> genderType = ['male', 'female'];
                  ...
                  children: [
                   ...
                   23.height,
                    ...
                    CustomDropdownMenuContainer(
                      labelText: "Gender",
                      items: ProfileSetupBody.genderType,
                    ...
                    CustomDropdownMenuContainer(
                      labelText: "Country",
                      items: ProfileSetupBody.countries,
                      initialValue: "USA",
                      onChanged: (value) {
                        country = value;
                      },
